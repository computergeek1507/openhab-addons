...
import org.openhab.binding.frigate.internal.FrigateDiscoveryService;
import org.openhab.binding.frigate.internal.dto.StataDTO;
...
/**
 * The {@link FrigateServerHandler} is responsible for communicating with the MyQ API based on an account.
 *
 * @author Scott Hanson - Initial contribution
 */
@NonNullByDefault
public class FrigateServerHandler extends BaseBridgeHandler implements AccessTokenRefreshListener {
    ...
    public Collection<Class<? extends ThingHandlerService>> getServices() {
        return Collections.singleton(FrigateDiscoveryService.class);
    }
