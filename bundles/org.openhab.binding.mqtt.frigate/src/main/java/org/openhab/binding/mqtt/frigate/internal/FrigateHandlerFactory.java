...
import static org.openhab.binding.mqtt.frigate.internal.FrigateBindingConstants.SUPPORTED_THING_TYPES;

import org.eclipse.jdt.annotation.NonNullByDefault;
import org.eclipse.jdt.annotation.Nullable;
import org.openhab.binding.mqtt.frigate.internal.handler.FrigateHubHandler;
...
public class FrigateHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (SUPPORTED_THING_TYPES.contains(thingTypeUID)) {
            return new FrigateHubHandler(thing, thingRegistry);
        }
