...
package org.openhab.binding.mqtt.frigate.internal.discovery;
...
/**
 * The {@link FrigateDiscoveryService} is responsible for finding globes
 * and setting them up for the handlers.
 *
 * @author Scott Hanson - Initial contribution
 */

@Component(service = DiscoveryService.class, configurationPid = "discovery.mqttfrigate")
@NonNullByDefault
public class FrigateDiscoveryService extends AbstractMQTTDiscovery {
